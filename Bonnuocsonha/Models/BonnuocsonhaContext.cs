...
using Bonnuocsonha.Models.Mapping;

namespace Bonnuocsonha.Models
{
    public partial class BonnuocsonhaContext : DbContext
    {
        static BonnuocsonhaContext()
        {
            Database.SetInitializer<BonnuocsonhaContext>(null);
        }

        public BonnuocsonhaContext()
            : base("Name=BonnuocsonhaContext")
        {
        }
        ...
        public DbSet<tblAssignRight> tblAssignRights { get; set; }
        ...
        public DbSet<tblCommentNew> tblCommentNews { get; set; }
        ...
        public DbSet<tblPopup> tblPopups { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new tblAssignRightMap());
            ...
            modelBuilder.Configurations.Add(new tblCommentNewMap());
            ...
            modelBuilder.Configurations.Add(new tblPopupMap());
            modelBuilder.Configurations.Add(new tblPriceMap());
