...
namespace Bonnuocsonha.Controllers.Display
{
    public class DefaultController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net\" />";
            string meta = "";
            meta += "<meta itemprop=\"name\" content=\"" + config.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + config.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://Bonnuocsonha.net" + config.Logo + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + config.Title + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://Bonnuocsonha.net" + config.Logo + "\" />";
