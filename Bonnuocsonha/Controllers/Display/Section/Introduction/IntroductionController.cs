...
namespace Bonnuocsonha.Controllers.Display.Section.Introduction
{
    public class IntroductionController : Controller
    {
        ...
        {
            var tblnews = db.tblNews.FirstOrDefault(p => p.idCate==8);
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/Gioi-thieu\" />";
            meta += "<meta itemprop=\"name\" content=\"" + tblnews.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + tblnews.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://Bonnuocsonha.net" + tblnews.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblnews.Title + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://Bonnuocsonha.net" + tblnews.Images + "\" />";
