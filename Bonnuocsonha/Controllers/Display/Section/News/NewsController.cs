...
namespace Bonnuocsonha.Controllers.Display.Section.News
{
    public class NewsController : Controller
    {
        ...
        public ActionResult NewsDetail(string tag)
        {
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/tin-tuc/" + StringClass.NameToTag(tag) + "\" />";
