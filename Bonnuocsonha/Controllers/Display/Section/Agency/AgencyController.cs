...
using PagedList;
using PagedList.Mvc;
namespace Bonnuocsonha.Controllers.Display.Section.Agency
{
    public class AgencyController : Controller
    {
        ...
        public ActionResult ListAgency(int? page)
        {
            ...
            ViewBag.Name = "Danh sách nhà phân phối bồn nước Sơn Hà chính hãng trên toàn quốc";
            ...
            ViewBag.Description = "<meta name=\"description\" content=\"Danh sách nhà phân phối bồn nước chính hãng trên toàn quốc . ĐỊa chỉ cung cấp bồn nước Sơn Hà giá rẻ nhất.\"/>";
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"bồn nước Sơn Hà\" /> ";
        ...
        public ActionResult TagAgency(string tag, int? page)
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/TagAgency/" + StringClass.NameToTag(chuoitag) + "\" />"; ;
            return View(listnews.ToPagedList(pageNumber, pageSize));
        }
        public ActionResult AngencyDetail(string tag)
        {
            ...
            string meta = "";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/Nha-phan-phoi/" + StringClass.NameToTag(tag) + "\" />";

            meta += "<meta itemprop=\"name\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + tblagency.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://Bonnuocsonha.net" + tblagency.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblagency.Name + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://Bonnuocsonha.net" + tblagency.Images + "\" />";
