...
namespace Bonnuocsonha.Controllers.Display.Section.Product
{
    public class ProductController : Controller
    {
        ...
        public ActionResult ProductDetail(string tag)
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/san-pham/" + StringClass.NameToTag(tag) + "\" />";
            string meta = "";
            ...
            meta += "<meta itemprop=\"image\" content=\"http://Bonnuocsonha.net" + tblproduct.ImageLinkThumb + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblproduct.Title + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://Bonnuocsonha.net" + tblproduct.ImageLinkThumb + "\" />";
            meta += "<meta property=\"og:site_name\" content=\"http://Bonnuocsonha.net\" />";
            ...
            int idp = tblproduct.id;
            var listTag = db.tblProductTags.Where(p => p.idp == idp).ToList();
            for (int i = 0; i < listTag.Count; i++)
            {
                chuoitag += "<h2><a href=\"/Tag/" + listTag[i].Tag + "\" title=\"" + listTag[i].Name + "\">" + listTag[i].Name + "</a></h2>";
            }
        ...
        public ActionResult ListProduct(string tag)
        {
            ...
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bonnuocsonha.net/" + StringClass.NameToTag(tag) + ".html\" />";
            string meta = "";
            meta += "<meta itemprop=\"name\" content=\"" + tblgroupproduct.Name + "\" />";
            meta += "<meta itemprop=\"url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta itemprop=\"description\" content=\"" + tblgroupproduct.Description + "\" />";
            meta += "<meta itemprop=\"image\" content=\"http://Bonnuocsonha.net" + tblgroupproduct.Images + "\" />";
            meta += "<meta property=\"og:title\" content=\"" + tblgroupproduct.Title + "\" />";
            meta += "<meta property=\"og:type\" content=\"product\" />";
            meta += "<meta property=\"og:url\" content=\"" + Request.Url.ToString() + "\" />";
            meta += "<meta property=\"og:image\" content=\"http://Bonnuocsonha.net" + tblgroupproduct.Images + "\" />";
            meta += "<meta property=\"og:site_name\" content=\"http://Bonnuocsonha.net\" />";
